...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def openFileNameDialog(self):
        ...
        self.input_hough.setPixmap(pixmap)
        self.input_hough.setScaledContents(True)   
...
######################################################################################################
    ...
    def HoughCircle(self):
        ...
        blur = self.median_blur.value()
        img = cv2.medianBlur(gray_img, blur)
        #cv2.imshow("img",img)
        ...
        for i in circles[0,:]:
            ...
            im.save("./Output images/Hough_Circle.jpg")
            pixmap = QPixmap("./Output images/Hough_Circle.jpg")
            self.output_hough.setPixmap(pixmap)
            self.output_hough.setScaledContents(True)  
